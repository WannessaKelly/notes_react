...
export function NewNoteCard({ oneNoteCreated }: NewNoteCardProps) {
    ...
    return(
    <Dialog.Root>
        <Dialog.Trigger className="flex flex-col rounded-md bg-slate-700 text-left p-5 gap-3 hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400 ">
            ...
            <form className='flex-1 flex flex-col'>
                <div className="flex flex-1 flex-col gap-3 p-5">
                    ...
                    {shouldShowOnbording ? (
                        ...
                        <textarea
                        autoFocus
                        className="text-medium leading-6 text-slate-400 bg-transparent resize-none flex-1 outline-none"
